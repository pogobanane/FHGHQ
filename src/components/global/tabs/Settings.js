        ...
        <div className="row">
          ...
          <div className="col">
            ...
            <table>
              <tbody>
                <tr>
                  <td className="settings_td1"><h5>Room name:</h5></td>
                ...
                <tr>
                  <td className="settings_td1"><h5>Password:</h5></td>
                  <td className="settings_td2">
                    {' '}
                    <input
                      type="text"
              ...
              <label className="form-check-label">
                <h5>
                  <input
                    ...
                    onChange={() => window.modalcontainer.ShowModal(3, 'unsecure')}
                  />
                Unsecure
                </h5>
              </label>
      ...
      <tr>
        <td className="textleft">
          <h6 className="userlist_header">
            ...
            <a href={`https://steamcommunity.com/profiles/${this.props.user.id}`} target="_blank">{` ${this.props.user.name}`}</a>
          </h6>
        </td>
