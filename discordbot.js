        ...
        fields: [
          {
            ...
            value:
              'Follow this link: https://discordapp.com/api/oauth2/authorize?client_id=530789519360917514&permissions=0&scope=bot',
          },
          {
            name: 'How do I link a room to the channel?',
            value:
              'If you are a Steam-logged user and a room moderator/owner, you can link the bot to the room by generating a discord token in the management tab and then writing !linkroom <token> in the desired discord channel where <token> is your generated token. You have to have management rights in the discord channel to do that.',
          },
          {
            name: 'Town hall/fort notifications',
            value:
              "If you have a discord channel linked to your bot, you can make bot notify you of events in desired town halls/forts by selecting a town/fort and clicking the 'Notify in Discord' checkbox.",
          },
          {
            name: 'Operation timers',
            value:
              'Discord emits a message when an operation is scheduled and when there is 1 hour left until the operation start.',
          },
          {
            name: 'Tech tree',
            value:
              'Discord emits a message when a research has been completed (this is based on user actions and is not linked to the game). Alternatively you can type !techtree and get all techs currently being researched (not empty and not full techs)',
          },
        ],
      };
      ...
      try {
        ...
        if (
          ...
          if (room == undefined) {
            ...
            message.channel.send({ embed });
            client.channels.get('520188265618472960').send(
              new Date().toLocaleString('en-US', {
                timeZone: 'America/New_York',
              }) +
                ` **${channelID} Channel registered for server ${message.guild.name} by ${message.author.username}**`
            );
        ...
        message.channel.send(
          "Error: Couldn't register channel. Channel doesn't exist or bot is lacking permissions"
        );
        //console.log(error)
      }
      break;
            ...
            for (let i = 0; i < techtree.length; i++) {
              if (global.techtree[techtree[i].name] != undefined) {
                ...
                if (tech > 0 && tech < techtree[i].needtech) {
                  fields.push({
                    name: techtree[i].name,
                    value: tech + '/' + techtree[i].needtech,
                  });
                }
              }
            }
...
exports.emitNotify = function (packet) {
  ...
  if (prevItem.teamId != newItem.teamId) {
    ...
    prevItem.iconType != newItem.iconType ||
    (prevItem.iconType == newItem.iconType &&
      prevItem.flags & 4 &&
      !(newItem.flags & 4))
  ) {
  ...
  switch (newItem.iconType) {
    case 5:
      if (newItem.teamId == 'NONE') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase1.png?v=1547289997432';
      } else if (newItem.teamId == 'COLONIALS') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase1Colonial.png?v=1547289997508';
      } else {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase1Warden.png?v=1547289997468';
      }
      break;
    case 6:
      if (newItem.teamId == 'NONE') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase2.png?v=1547288289597';
      } else if (newItem.teamId == 'COLONIALS') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase2Colonial.png?v=1547289997577';
      } else {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase2Warden.png?v=1547289997541';
      }
      break;
    case 7:
      if (newItem.teamId == 'NONE') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase3.png?v=1547288290801';
      } else if (newItem.teamId == 'COLONIALS') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase3Colonial.png?v=1547289997637';
      } else {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconStaticBase3Warden.png?v=1547289997109';
      }
      break;
    case 29:
      if (newItem.teamId == 'NONE') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconFort.png?v=1547289047513';
      } else if (newItem.teamId == 'COLONIALS') {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconFortColonial.png?v=1547289997157';
      } else {
        url =
          'https://cdn.glitch.com/6393f3fd-16a7-4641-ae3d-994f8e7cea4e%2FMapIconFortWarden.png?v=1547289997217';
      }
  }
...
exports.emitOnlineCount = function (count, dbcount) {
  try {
    client.channels
      .get('531113716905803777')
      .send(
        'Users online: ' +
          count +
          '\nTotal Steam-logged users: ' +
          dbcount.steamcount +
          '\nTotal anonymous users: ' +
          dbcount.nosteamcount +
          '\nDate: ' +
          new Date()
      );
  } catch (err) {}
