...
export function GetLine(array, index, facilities) {
  ...
  return (
    <React.Fragment key={array + index}>
      <img
        className='tooltip_img'
        src={facilitytypes.array[array][index].src}
      />
      {numberstring}
      <br />
    </React.Fragment>
