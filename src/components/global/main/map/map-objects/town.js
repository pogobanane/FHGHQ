...
class Town_ extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      JSON.stringify(this.props.stockpiles) !=
      JSON.stringify(nextProps.stockpiles)
    ) {
      if (
        this.props.stockpiles[this.props.signature] == undefined &&
        nextProps.stockpiles[this.props.signature] == undefined
      ) {
        return false;
      }
      if (
        JSON.stringify(this.props.stockpiles[this.props.signature]) ===
        JSON.stringify(nextProps.stockpiles[this.props.signature])
      ) {
        return false;
      }
      return true;
